...
router.post('/create_category', async (req, res) => {
    ...
    await category.save().then(post => console.log("Создана новая запись " + post.name + " в categories с ID:" + post._id)) // вывод записи в консоль
...
router.post('/create_service', async (req, res) => {
    ...
    await service.save().then(post => console.log("Создана новая запись " + post.name + " в services с ID:" + post._id)) // вывод записи в консоль
